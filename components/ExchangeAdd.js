...
import { View, Text, StyleSheet, TextInput, ActivityIndicator, ImageBackground, TouchableOpacity } from 'react-native';
import axios from 'axios';

export default function ExchangeAdd({ route, navigation }) {
  const { token, customer_ID,Role,DFI_Movement_ID} = route.params;
